        ...
        public IList<Product> productList = new List<Product>
                {
                    ...
                    new Product{ImageSource = "/Content/images/samsung-galaxy-s3.jpg" ,Category = "Electronic Products",Name ="Samsung Galaxy S3",
                        Description = "With a 4.8 inch HD Super AMOLED display, the GALAXY S III offers a large and vivid viewing experience. Samsung Mobile's heritage Super AMOLED display even enhances to HD and 16:9 wider viewing angles.With the innovative smart stay feature, Galaxy S III automatically recognises when you are looking at the phone, whether it is to read an e-book or browse the web. The front camera looks deep into your eyes and maintains a bright display for continued viewing pleasure"}
                };
